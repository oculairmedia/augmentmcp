...
- **Project Code**: `AUGMT`
- **Project Name**: Augment MCP Tool
- **Letta Agent ID**: `agent-5a8ec754-6816-4972-b3a1-74c1cb36a6b9`

## Workflow Instructions

1. **Before starting work**: Search Huly for related issues using `huly-mcp` with project code `AUGMT`
2. **Issue references**: All issues for this project use the format `AUGMT-XXX` (e.g., `AUGMT-123`)
...
**Project PM Agent:** `Huly - Augment MCP Tool` (agent-5a8ec754-6816-4972-b3a1-74c1cb36a6b9)
...
```json
{
  ...
  "agent": "Huly - Augment MCP Tool",
  "message": "<your report>",
  "caller_directory": "/opt/stacks/augment-mcp-tool"
}
```
...
**Project**: Augment MCP Tool (`AUGMT`)
**Path**: `/opt/stacks/augment-mcp-tool`
